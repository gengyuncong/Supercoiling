...
# global config:
#'''
inter_len = int(sys.argv[2]) #2,4,8,10,20,50,100
...
'''
promoter_list=[121+inter_len/2]; #81+inter_len/2, 
terminator_list=[140+inter_len/2]; #100+inter_len/2, 

promoter_list2=[120-inter_len/2]; #80-inter_len/2, 79
terminator_list2=[101-inter_len/2]; #61-inter_len/2, 60
'''

promoter_list=[90+inter_len/2]; #81+inter_len/2, 
terminator_list=[110+inter_len/2]; #100+inter_len/2, 

promoter_list2=[90-inter_len/2]; #80-inter_len/2, 79
terminator_list2=[70-inter_len/2]; #61-inter_len/2, 60
...
###########################################
# write files
filename='div.'+str(sys.argv[1])+'.'+str(sys.argv[2])+'.sbml'
f = open(filename, 'w')
wirte_head(f);
