...
#initiation_rate=0.1;
initiation_rate=float(sys.argv[1]);
initiation_list = [0.05, initiation_rate];
...
'''
promoter_list=[101-inter_len/2, 121+inter_len/2]; #61-inter_len/2, 60
terminator_list=[120-inter_len/2, 140+inter_len/2]; #80-inter_len/2, 79
'''

promoter_list=[70-inter_len/2, 90+inter_len/2]; #61-inter_len/2, 60
terminator_list=[90-inter_len/2, 110+inter_len/2]; #80-inter_len/2, 79

Boundary0_list = [0, 0];
Boundary1_list = [-0.06, -0.06];
...
###########################################
# write files
filename='tand.'+str(sys.argv[1])+'.'+str(sys.argv[2])+'.sbml'
f = open(filename, 'w')
wirte_head(f);
