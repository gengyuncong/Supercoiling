...
elongation_rate=60;
diffusion_rate=50; 
#diffusion_rate=float(sys.argv[2]); #5, 50, 500, 5000
#diffusion_rate=500;
...
#topoI_unbinding_rate=float(sys.argv[3]); #0.001, 0.01, 0.1, 1, 10
topoI_unbinding_rate = 1; 
...
###########################################
# write files
filename='rot.'+str(sys.argv[1])+'.'+str(sys.argv[2])+'.sbml';
f = open(filename, 'w')
wirte_head(f);
